...
* Grunt has been replaced with using Webpack directly as the build system.
* The auto-generated documentation has been removed from the repository, as it can be regenerated by running `npm run doc`.
