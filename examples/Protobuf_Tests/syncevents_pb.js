...
proto.NewSyncTLEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    timestamp: (f = msg.getTimestamp()) && proto.CorrelationTimestamp.toObject(includeInstance, f)
  };
...
proto.NewSyncTLEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 9:
      ...
      break;
    case 10:
      var value = new proto.CorrelationTimestamp;
      reader.readMessage(value,proto.CorrelationTimestamp.deserializeBinaryFromReader);
...
proto.NewSyncTLEvent.prototype.serializeBinaryToWriter = function (writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      10,
      f,
      proto.CorrelationTimestamp.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional CorrelationTimestamp timestamp = 10;
 * @return {proto.CorrelationTimestamp}
 */
proto.NewSyncTLEvent.prototype.getTimestamp = function() {
  return /** @type{proto.CorrelationTimestamp} */ (
    jspb.Message.getWrapperField(this, proto.CorrelationTimestamp, 10));
};


/** @param {proto.CorrelationTimestamp|undefined} value  */
