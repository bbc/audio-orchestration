...
const TestQueueConsumer = require("./testqueueprotobufconsumer");
...
var redisClient, redissmqConfig, eventConsumer;
...
discoverService(redisService)
	...
	.then(function(result){
		...
		eventConsumer = new TestQueueConsumer(redissmqConfig.getConfig(), { messageConsumeTimeout: 2000 });
		eventConsumer.run();
