...
describe('HrtfChannelHandler', () => {
  ...
  it('should extend ChannelHandler', () => {
    ...
    const channelHandler = new HrtfChannelHandler(context);
  ...
  it('should expose a static factory function', () => {
    ...
    expect(channelHandler).toEqual(jasmine.any(HrtfChannelHandler));
  });
